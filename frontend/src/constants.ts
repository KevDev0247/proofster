export const prompt = "A brief description of the selected algorithm or its result will be displayed here. Select an algorithm and press EXECUTE to continue"
